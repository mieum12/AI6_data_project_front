      ...
      <S.PlusList>
        <div className="BoxList">
          <Box
            ...
            LinkName="국민재난안전포털"
            boxText1="▫️ 재난 현황 확인"
            boxText2=": 재난 정보 조회 및 상황 정보 등"
            boxText3="▫️ 타 안전시설 확인"
            boxText4=": 지진 대피소, 민방위 대피소 등"
            // boxText1={[
            //   "▫️ 재난 현황 확인",
            //   ": 재난 정보 조회 및 상황 정보 등",
            //   "▫️ 타 안전시설 확인",
          ...
          <Box
            ...
            boxText2="▫️ 온라인 민원 신청 안내"
            boxText3="▫️ 이재민 관련 지원 사업, 신속 보도자료 등 확인"
            // boxText1={[
            //   "▫️ 국가 안전 시스템 정책 소개",
            //   "▫️ 온라인 민원 신청 안내",
          ...
          <Box
            ...
            boxText2=": 재난 발생 통계, 재난 보고 등"
            boxText3="▫️ 사고별 대응 요령 소개"
            boxText4="▫️ 시민 참여 활동: 자원봉사"
            // boxText1={[
            //   "▫️ 재난 정보 서비스 소개",
            //   ": 재난 발생 통계, 재난 보고 등",
            //   "▫️ 사고별 대응 요령 소개",
